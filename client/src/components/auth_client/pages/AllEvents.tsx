...
const AllEvents = () => {
  ...
  const ongoingEvents = events.filter((event) => {
    ...
    const endDate = event.endDate
      ...
      : new Date(startDate.getTime() + 24 * 60 * 60 * 1000); // Default to 24h if no endDate
      ...
      <div className="flex border-b border-zinc-200 dark:border-zinc-800">
        ...
        >
          ...
          {upcomingEvents.length > 0 && (
            <span className="ml-2 px-2 py-0.5 text-xs bg-zinc-100 dark:bg-zinc-800 rounded-full">
        ...
        >
          ...
          {ongoingEvents.length > 0 && (
            <span className="ml-2 px-2 py-0.5 text-xs bg-green-100 dark:bg-green-900/20 text-green-600 rounded-full">
